...
public class Evo{
  ...
  public static final int grid_size = 125;  //Size of the world. 1/5th of tiles will contain food, 1/10th mushrooms.
  public static final int creature_count = 60; //Number of creatures in the simulation, monster cound will be half this.
  ...
  public static void initialize(){
    ...
    for(int i = 0; i < ((grid_size*grid_size)/10); i++){
      int x = r.nextInt(grid_size);
      int y = r.nextInt(grid_size);
